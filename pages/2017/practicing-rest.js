...
export default () => (
  <Page>
    ...
    <Content>
      <h1>Practicing Rest</h1>
      <p>I've been noticing something lacking in my life. This thing is <em>rest</em>.</p>
      <p>Like most Americans, I've been taught what it means to work. I know how to wake up early and pull all-nighters.
      ...
      spiritual act of focus? It's corny to say, but for me resting can be hard work.</p>
    </Content> 
  </Page>
)
